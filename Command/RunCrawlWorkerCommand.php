...
class RunCrawlWorkerCommand extends \Symfony\Component\Console\Command\Command
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addOption('concurrency', null, InputOption::VALUE_REQUIRED, 'Max number of simulatenous warmup requests', $this->configuration->getDefaultConcurrency())
            ...
            ->addOption('target-ttfb', null, InputOption::VALUE_REQUIRED, 'Target TTFB (in seconds) to keep below or start throttling', $this->configuration->getDefaultTargetTTFB())
